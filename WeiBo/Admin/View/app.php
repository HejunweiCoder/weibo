...
<nav class="nav navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a href="/user">ThinkPHP</a></li>
        </ul>
        <div class="collapse navbar-collapse" id="app-navbar-collapse" style="margin-left:185px;">
            <ul class="nav navbar-nav">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"><a href="#" data-toggle="dropdown">{$auth.name} <span class="caret"></span></a>
